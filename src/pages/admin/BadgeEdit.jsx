                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-[#091238] rounded-lg shadow-lg p-6">
                            ...
                            <form onSubmit={handleSubmit}>
                                {/* Row for Badge Name and Description */}
                                <div className="flex items-start space-x-6 mb-6">
                                    {/* Badge Name */}
                                    <div className="flex-1">
                                        <h3 className="text-white text-sm font-medium mb-2">Tên danh hiệu</h3>
                                        {isEditing ? (
                                            <input
                                                type="text"
                                                name="name"
                                ...
                                {/* Row for Area and Image URL */}
                                <div className="flex items-start space-x-6 mb-6">
                                    {/* Area */}
                                    <div className="flex-1">
                                        <h3 className="text-white text-sm font-medium mb-2">Khu vực</h3>
                                        {isEditing ? (
                                            <input
                                                type="text"
                                                name="area"
                                    ...
                                    {/* Image URL */}
                                    <div className="flex-1">
                                        <h3 className="text-white text-sm font-medium mb-2">URL Hình ảnh</h3>
                                        {isEditing ? (
                                            <input
                                                type="url"
                                                name="imageUrl"
                                            ...
                                            <a href={formData.imageUrl} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">{formData.imageUrl}</a>
                                        )}
                                    </div>
                                </div>
