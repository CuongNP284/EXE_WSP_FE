...
import { Calendar, Clock, MapPin, Users, DollarSign, Send } from 'lucide-react';
...
const ViewWsDetail = () => {
  ...
  // Mock workshop data based on the images
  const workshopData = {
  ...
  const handleSubmitForApproval = () => {
    ...
    // Simulate API call
    setTimeout(() => {
      message.success('Workshop đã được gửi cho admin để duyệt!');
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center justify-between">
                ...
                <div>
                  <Popconfirm
                    title="Gửi workshop để duyệt"
                    description="Bạn có chắc chắn muốn gửi workshop này cho admin để duyệt không?"
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mt-6">
              ...
              <div className="prose max-w-none">
                <p className="text-gray-600 leading-relaxed">
                  ...
                  Trong suốt khóa học, bạn sẽ được hướng dẫn các tư thế cơ bản, kỹ thuật th呼 hấp và thiền định.
